...
from funnotify import notify
from pynotify import notify

doesn't work well with fns that have been decorated bc of fn.__name__ and stack strace
...
#            notes=None, error=True, host=None, persist=False):
#     if persist:
...
#         return wrapper
#     if function is None: # if notifiy is used w/ args passed
#         return decorator # return fn that decorates
#     return decorator(function) # return decorated fn
# =============================================================================
